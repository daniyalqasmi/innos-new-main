...
const Footer = () => {
  return (
    ...
    >
      ...
      <div className="mt-12 border-t border-[#8890A4] border-opacity-40 py-8 lg:mt-[60px]  relative z-10 bg-[#58c0c2] pt-20 lg:pt-[100px]">
          ...
          <div className="-mx-4 flex flex-wrap">
            ...
            <div className="w-full px-4 md:w-1/3 lg:w-1/2">
              <div className="my-1 flex justify-center md:justify-end">
                ...
                © 2024 | Alle rettigheter forbeholdt | Drevet av Innoscribe
                </p>
              </div>
            </div>
          </div>
